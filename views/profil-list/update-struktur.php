    ...
    <?= $form->field($model, 'images')->widget(\bilginnet\cropper\Cropper::className(), [
                    ...
                    'cropperOptions' => [
                        'preview' => [
                            ...
                            'width' => 960, // must be specified // you can set as string '100%'
                            'height' => 1920, // must be specified // you can set as string '100px'
                        ],
                        'width' => 889, // must be specified // you can set as string '100%'
